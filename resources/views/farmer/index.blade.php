        ...
        <h3 class="h3-search">Search Area</h3>
            <div class="list-group">
                ...
                <ul>
                   <li>
                       <button action="url('#')">
                       <input type="radio"  name="area" id="jaffna" value="jaffna"><i class="fa fa-heart fa-fw"></i>
                       </button>
                       <label for="jaffna" ><span>Jaffna</span></label>
...
<div id="content1">
    ...
    <div class="cardtotal ">
        <div class="card">
            <div class="image">
            <img class="avatar" src="farmerpage/facebook-profile-picture-affects-chances-of-gettin_gstt.jpg" alt="description of ">
            </div>
            
            <h4>Name : Jenthan</h4>
            <h4>Area : Nallur</h4>
            <button>
                 <a href="{{url('farmerdisplay')}}" >More...</a>
            </button>
        ...
        <div class="image">
            ...
            <h4>Area : Nallur</h4>
            <button>
                 <a href="{{route('farmerdisplay')}}" >More...</a>
            </button>
        </div>
        <div class="card">
        <div class="image">
