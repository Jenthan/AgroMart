...
@if ($errors->any())
    ...
    <form class="border border-success rounded-3" method="post" action="{{url('customerregistration')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mb-2">
            <label for="cname" class="col-sm-2 col-form-label-sm">Customer Name:</label>
            <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm" id="cname" name="name">
            </div>
        </div>
